...
public class JDBCContract {
	...
	private static final String POSTGRES_CONNECTION_URL = "jdbc:postgresql://localhost:5432/TaxiReferralSDSDB";
	private static final String POSTGRES_CONNECTION_URL_PREPARED = "jdbc:postgresql://localhost:5432/TaxiReferralSDSDB?prepareThreshold=3";
